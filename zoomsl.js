...
(function ($, global) {
    ...
    $.extend(sergelandimagezoomer, {
        ...
        dsetting: { //default settings
            ...
            cursorshadecolor: 'transparent', // цвет контейнера лупы в формате CSS
            cursorshadeopacity: 0.3, // прозрачность контейнера лупы
            cursorshadeborder: '1px solid transparent', // внешний бордюра контейнера лупы в формате CSS
